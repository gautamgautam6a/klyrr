...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center items-center py-4 bg-transparent">
      <div className={cn(
        "container max-w-7xl px-8 bg-white rounded-full transition-all duration-300",
