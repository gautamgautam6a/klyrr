...
const features = [
  {
    icon: '🎯',
    title: 'ICP Mapping + Data Enrichment',
    desc: '→ Built with Clay, Apollo, Groq — 100% precision targeting',
  },
  {
    icon: '📬',
    title: 'Cold Outreach System',
    desc: '→ Persona-specific email & LinkedIn flows that create urgency, not annoyance',
  },
  {
    icon: '🧠',
    title: 'Reply Intelligence Bot',
    desc: '→ AI replies instantly to objections, FAQs, and CTAs — so no lead goes cold',
  },
  {
    icon: '📈',
    title: 'Inbound Amplification',
    desc: '→ CRO-tuned landing pages + proof-rich content built to convert silent lurkers',
  },
  {
    icon: '🧪',
    title: 'Weekly Signal-Based Optimization',
    desc: '→ Every reply type, every bounce, every "not now" feeds back into smarter ops',
  },
]

const ZeroToPipeline: React.FC = () => (
  <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden gradient-hero">
    ...
    <div className="container relative z-10 max-w-5xl mx-auto">
      ...
      <div className="pt-32 pb-16 text-center animate-fade-in-up">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-blue-600 mb-6 text-center heading-gradient text-balance mb-4">
