        ...
        <div className="border-t border-blue-200 pt-8 mb-8">
          <div className="max-w-md">
            ...
            <p className="text-gray-600 mb-4">
              Get the latest updates on new features and case studies.
            </p>
            <form className="flex gap-x-3">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="min-w-0 flex-auto rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 text-sm sm:leading-6"
                placeholder="Enter your email"
              />
              <Button className="inline-flex items-center justify-center gap-2 h-9 px-8 py-4 text-base rounded-md bg-blue-600 hover:bg-blue-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 font-medium">
                Subscribe
              </Button>
            </form>
          </div>
